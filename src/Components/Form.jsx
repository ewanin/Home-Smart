  ...
  return (
    <section aria-labelledby="contact" className="container mx-auto px-8 overflow-hidden">
        <div className="flex flex-wrap justify-center gap-12 md:gap-6 lg:gap-20">
            ...
            <form action="" className="realtive border-8 border-neutral-900 p-6 rounded-lg grid gap-8 md:flex-1 md:max-w-lg my-4 md:my-12 lg:my-16 bg-white dark:bg-neutral-800 2-full">
                <h2 id='contact' className='text-3xl font-bold'>Let's Connect</h2>
                <div className='relative'>
                    <input type="text" id='name' className='peer form-input w-full border-4 border-amber-400 rounded-md focus:ring-3 dark:ring-offset-2 focus:ring-amber-400 focus:border-amber-400 focus:outline-none dark:bg-amber-400 dark:text-neutral-900 placeholder-transparent' placeholder='Your Name' />
                    <label htmlFor="name" className='text-neutral-500 text-sm font-bold uppercase absolute -top-4 left-2 -translate-y-1/2 peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-neutral-900 peer-focus:-top-4 peer-focus:left-2 peer-focus:text-neutral-600 dark:peer-focus:text-neutral-300 transition-all '>Your Name</label>
                </div>

                <div className='relative'>
                    <input type="email" id='email' className='peer form-input w-full border-4 border-amber-400 rounded-md focus:ring-3 dark:ring-offset-2 focus:ring-amber-400 focus:border-amber-400 focus:outline-none dark:bg-amber-400 dark:text-neutral-900 placeholder-transparent' placeholder='Your Email' />
                    <label htmlFor="email" className='text-neutral-500 text-sm font-bold uppercase absolute -top-4 left-2 -translate-y-1/2 peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-neutral-900 peer-focus:-top-4 peer-focus:left-2 peer-focus:text-neutral-600 dark:peer-focus:text-neutral-300 transition-all '>Your Email</label>
                </div>

                <div className='relative'>
                    <textarea name="content" id="content" cols="20" rows="5" className='peer form-textarea resize-none w-full border-4 border-amber-400 rounded-md focus:ring-3 dark:ring-offset-2 focus:ring-amber-400 focus:border-amber-400 focus:outline-none dark:bg-amber-400 dark:text-neutral-900 placeholder-transparent' placeholder='How can we help?'></textarea>
